// Package deferredtool implements DeferredToolFilterMiddleware for GoClaw.
//
// DeferredToolFilterMiddleware hides deferred tool schemas from the model
// when tool_search is enabled, preventing schema pollution and allowing
// dynamic tool discovery at runtime.
package deferredtool
